...
if(IOS_SDK_PATH)
    set(CMAKE_C_COMPILER "zig" cc -target aarch64-ios --sysroot=${IOS_SDK_PATH})
    set(CMAKE_CXX_COMPILER "zig" c++ -target aarch64-ios --sysroot=${IOS_SDK_PATH})
    message(STATUS "Using iOS SDK: ${IOS_SDK_PATH}")
else()
    set(CMAKE_C_COMPILER "zig" cc -target aarch64-ios)
    set(CMAKE_CXX_COMPILER "zig" c++ -target aarch64-ios)
